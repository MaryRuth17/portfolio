...
import { Github, Linkedin, Twitter, Heart, Mail, ArrowUpRight } from "lucide-react";
...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/50 py-10 transition-colors duration-500">
